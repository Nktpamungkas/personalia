...
class Data_Karyawan extends CI_Controller
{
    ...
    public function print_datakaryawan($no_scan)
    {
        ...
        $data['makar'] = $this->db->query("SELECT *, date_format(tgl_masuk, '%d') AS tgl_masuk_hari, date_format(tgl_masuk, '%M') AS tgl_masuk_bulan, date_format(tgl_masuk, '%y') AS tgl_masuk_tahun FROM tbl_makar WHERE no_scan = '$no_scan'")->row();
    ...
    // public function Proses_resign($username)
    //     {
    //         $data = array(
    //             'tgl_resign'        => $this->input->post('tgl_resign')
    //             // 'status_karyawan'   => 'Resigned',
    ...
    //         $this->session->set_flashdata('message', '<center class="alert alert-success" role="alert"><b>Your Employee has been resigned and Email successfully sent.</b></center>');
    //         redirect('data_karyawan');
    //     }
