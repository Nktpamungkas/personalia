        ...
        <div class="row mt">
            <div class="col-lg-12 main-chart">
                ...
                <div class="row mb">
                    <p>
                        <center>
                            <h4><b>DATA HABIS KONTRAK</b></h4>
                        </center>
                        <?php if ($user['dept'] == "HRD" || $user['dept'] == "DIT") : ?>
                        <a href="#" data-toggle="modal" data-target="#modalAddKontrak"
                            class="btn btn-primary btn-xs">Tambah data karyawan kontrak</a>
                        <a href="<?= base_url('PKWT/ExportToExcell'); ?>" class="btn btn-warning btn-xs">Export data
                            karyawan kontrak</a>
                        <?php endif; ?>
                    <div class="modal fade" id="modalAddKontrak" tabindex="-1" role="dialog"
                        aria-labelledby="modalAddKontrak" aria-hidden="true">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title"><i class="fa fa-plus"></i> Tambah data karyawan kontrak
                                        </h4>
                                    </div>
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="form-group col-sm-12">
                                                <label class="control-label col-lg-4">Nama Karyawan <span
                                                        style="color: red">(*)</span></label>
                                                <div class="col-lg-8">
                                                    <select class="form-control input-sm" tabindex="2"
                                                        data-placeholder="Pilih NIP Karyawan..." name="no_scan"
                                                        required>
                                            ...
                                            <div class="form-group col-md-12">
                                                <label class="control-label col-lg-4">Status Karyawan <span
                                                        style="color: red">(*)</span></label>
                                                <div class="col-lg-8">
                                                    <select class="form-control input-sm" name="status_karyawan"
                                                        required>
                                                        <?php
                                            ...
                                            <div class="form-group col-sm-12">
                                                ...
                                                <div class="col-lg-4">
                                                    <input class="form-control input-sm" name="upah" id="upah"
                                                        type="text">
                                                </div>
                                                <div class="col-lg-4">
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" onclick="functionGaji()" name="gaji"
                                                            id="gaji"> Upah Minimum Regional
                                                        (<i>Rp.
                                                            <?php 
                                            ...
                                            <div class="form-group col-sm-12">
                                                <label for="kontrak_awal" class="control-label col-lg-4">Tgl kontrak
                                                    awal</label>
                                                <div class="col-lg-4">
                                                    <input class="form-control input-sm"
                                                        value="<?= set_value('kontrak_awal'); ?>" id="kontrak_awal"
                                                        name="kontrak_awal" type="date">
                                            ...
                                            <div class="form-group col-sm-12">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <input type="number" id="input_jumlah_bulan" name="durasi"
                                                        placeholder="Jumlah Bulan" value="" min="1" required>
                                                </div>
                                            </div>
                                            <div class="form-group col-sm-12">
                                                <label class="control-label col-lg-4">Tgl kontrak akhir</label>
                                                <div class="col-lg-8">
                                                    <input class="form-control input-sm" id="kontrak_akhir"
                                                        name="kontrak_akhir" type="date">
                                                </div>
                                            </div>
                                            <div class="form-group col-sm-12">
                                                <label class="control-label col-lg-4">Keterangan</label>
                                                <div class="col-lg-8">
                                                    <input class="form-control input-sm" name="libur" type="text"
                                                        placeholder="Kosongkan jika tidak ada libur">
                                                    <label style="font-size: 10px;">(Contoh: 01 Maret 2020 - 02 Maret
                                                        2020)</label>
                                                    <input value=" <?php echo $this->session->name ;?>" name="username"
                                                        type="hidden">
                                                </div>
                                            </div>
                    ...
                    <p>
                        <label><b>*Note: Menampilkan data habis kontrak pertanggal saat ini sampai dengan 6 bulan
                                kedepan.</b></label>
                    </p>
                    <div class="content-panel">
                        <table style="width:100%" cellpadding="0" cellspacing="0" border="0"
                            class="display table table-bordered" id="PKWT">
                            <thead>
                                <tr>
                                    ...
                                    <td>
                                        <li class="dropdown" style="list-style-type:none;">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="<?= base_url(); ?>PKWT/index_pkwt/<?= $result['no_scan']; ?>"
                                                        style="color: black; font-size:13px;">Perpanjang kontrak</a>
                                                </li>
                                                <li>
                                                    <a href="#" data-toggle="modal"
                                                        data-target="#modalHapusKontrak<?= $result['id'] ?>"
                                                        style="color: black; font-size:13px;"><i
                                                            class="fa fa-trash"></i> Hapus</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <div class="modal fade" id="modalHapusKontrak<?= $result['id']; ?>"
                                            tabindex="-1" role="dialog" aria-labelledby="modalHapusKontrak"
                                            aria-hidden="true">
                                            <form role="form"
                                                action="<?= base_url('PKWT/hapus_kontrak/') . $result['no_scan']; ?>"
                                                method="POST">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h3 class="modal-title">Apakah anda yakin ingin menghapus
                                                                data ini ? </h3>
                                                        </div>
                                                        <div class="modal-footer">
            ...
            <p>
                <center>
                    <h4><b>KARYAWAN YANG DIPERPANJANG</b></h4>
                </center>
                <a href="#" data-toggle="modal" data-target="#modalPrint" class="btn btn-theme04 btn-xs">Buat Internal
                    Memo</a>
                <a href="#" data-toggle="modal" data-target="#modalMemo" class="btn btn-theme btn-xs">Daftar Memo
                    Karyawan Kontrak</a>
                <a href="<?= base_url('PKWT/ExportToExcell_perpanjang'); ?>" class="btn btn-warning btn-xs">Export data
                    karyawan yang diperpanjang</a>
            </p>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"
                                    aria-hidden="true">&times;</button>
                                <h4 class="modal-title"><i class="fa fa-calendar"></i> Internal Memo Karyawan Kontrak
                                </h4>
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <ul class="list-group">
                                            <li class="list-group-item"><b>No Memo :</b> <input type="text"
                                                    name="nomor_memo" class="form-control input-sm" required></li>
                                            <li class="list-group-item"><b>Periode Awal :</b> <input type="date"
                                                    name="tgl_mulai" class="form-control input-sm" required></li>
                                            <li class="list-group-item"><b>Periode Akhir :</b> <input type="date"
                                                    name="tgl_akhir" class="form-control input-sm" required></li>
            ...
            <p>
                <label><b>*Note: Menampilkan data karyawan yang diperpanjang per 1 bulan kebelakang dari hari ini sampai
                        dengan 1 tahun berikutnya.</b></label>
            </p>
            <div class="modal fade" id="modalMemo" tabindex="-1" role="dialog" aria-labelledby="modalMemo"
                aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-sm-12">
                                    <table style="width:100%" cellpadding="0" cellspacing="0" border="0"
                                        class="display table table-bordered" id="PKWT-memo">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $result['fperiode_awal']; ?> s/d
                                                    <?= $result['fperiode_akhir']; ?></td>
                                                <td><?= $result['nama']; ?></td>
                                                <td>
                                                    <a href="#" data-toggle="modal"
                                                        data-target="#modalMemoEdit<?= $result['id']; ?>"
                                                        class="btn btn-theme04 btn-sm"><i class="fa fa-edit"></i>
                                                        Edit</a>

                                                    <a href="<?= base_url('PKWT/print_memo/') ?><?= $result['id']; ?>"
                                                        class="btn btn-success btn-sm"><i class="fa fa-print"></i>
                                                        Print</a>
                                                </td>
                                            </tr>
                                            <div class="modal fade" id="modalMemoEdit<?= $result['id']; ?>"
                                                tabindex="-1" role="dialog" aria-labelledby="modalMemoEdit"
                                                aria-hidden="true">
                                                <form action="<?= base_url('PKWT/edit_memo/'); ?><?= $result['id']; ?>"
                                                    method="POST">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title"><i class="fa fa-calendar"></i>
                                                                    Edit Internal Memo </h4>
                                                            </div>
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="form-group col-sm-12">
                                                                        <ul class="list-group">
                                                                            <li class="list-group-item"><b>No Memo :</b>
                                                                                <input type="text" name="nomor_memo"
                                                                                    value="<?= $result['nomor_memo']; ?>"
                                                                                    class="form-control input-sm"
                                                                                    required></li>
                                                                            <li class="list-group-item"><b>Periode Awal
                                                                                    :</b> <input type="date"
                                                                                    name="tgl_mulai"
                                                                                    value="<?= $result['periode_awal']; ?>"
                                                                                    class="form-control input-sm"
                                                                                    required></li>
                                                                            <li class="list-group-item"><b>Periode Akhir
                                                                                    :</b> <input type="date"
                                                                                    name="tgl_akhir"
                                                                                    value="<?= $result['periode_akhir']; ?>"
                                                                                    class="form-control input-sm"
                                                                                    required></li>
                                                                            <li class="list-group-item">
                                                                                <b>Dibuat Oleh :</b>
                                                                                <select class="form-control input-sm"
                                                                                    tabindex="2" name="dibuat_oleh">
                                                                                    ...
                                                                                    <?php foreach ($queryShift as $dk) : ?>
                                                                                    <option
                                                                                        value="<?= $dk['no_scan'] ?>" <?php if ($dk['no_scan'] == $result['dibuat_oleh']) {
                                                                                                            echo "SELECTED";
                                                                                                        } ?>>
                                                                                        <?= $dk['nama']; ?></option>
                                                                                    <?php endforeach ?>
                                                                            ...
                                                                            <li class="list-group-item">
                                                                                ...
                                                                                <select class="form-control input-sm"
                                                                                    ...
                                                                                    <?php foreach ($queryShift as $dk) : ?>
                                                                                    <option
                                                                                        value="<?= $dk['no_scan'] ?>" <?php if ($dk['no_scan'] == $result['mengetahui']) {
                                                                                                            echo "SELECTED";
                                                                                                        } ?>>
                                                                                        <?= $dk['nama']; ?></option>
                                                                                    <?php endforeach ?>
                                                                            ...
                                                                            <li class="list-group-item">
                                                                                ...
                                                                                <input type="text"
                                                                                    class="form-control input-sm"
                                                                                    name="menyetujui"
                                                                                    value="<?= $result['menyetujui']; ?>">
                                                                                <input type="text"
                                                                                    class="form-control input-sm"
                                                                                    name="jabatan" placeholder="Jabatan"
                                                                                    value="<?= $result['jabatan']; ?>">
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                        ...
                        <?php 
                                    ...
                                    if ($dpt == "HRD") {
                                        $data = $this->db->query("SELECT b.id,
																	...
																	WHERE
																		b.kontrak_akhir BETWEEN DATE_ADD( NOW( ), INTERVAL -45 day ) 
                        ...
                        <tr class="gradeX">
                            <td>
                                <li class="dropdown" style="list-style-type:none;">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="<?= base_url(); ?>PKWT/index_pkwt_history/<?= $result['no_scan']; ?>"
                                                style="color: black; font-size:13px;"><i class="fa fa-eye"></i> Lihat
                                                History Kontrak</a>
                                        </li>
                                        <?php if($user['dept'] == "HRD") : ?>
                                        <li>
                                            <a href="#" data-toggle="modal"
                                                data-target="#modalVerifikasi<?= $result['id']; ?>"
                                                style="color: black; font-size:13px;"><i class="fa fa-check"></i>
                                                Verifikasi</a>
                                        </li>
                                        <li>
                                            <a href="#" data-toggle="modal"
                                                data-target="#modalHapus<?= $result['id'] ?>"
                                                style="color: black; font-size:13px;"><i class="fa fa-trash"></i>
                                                Hapus</a>
                                        </li>
                                ...
                                <div class="modal fade" id="modalHapus<?= $result['id']; ?>" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h3 class="modal-title">Apakah anda yakin ingin menghapus data ini ?
                                                    </h3>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-default"
                                ...
                                <div class="modal fade" id="modalVerifikasi<?= $result['id']; ?>" tabindex="-1"
                                    role="dialog" aria-labelledby="modalVerifikasi" aria-hidden="true">
                                    <form action="<?= base_url(); ?>PKWT/verifikasi/<?= $result['id']; ?>"
                                        method="POST">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-hidden="true">&times;</button>
                                                    <h4 class="modal-title"><i class="fa fa-check"></i> Verifikasi data
                                                        Perjanjian Kerja Waktu Tertentu </h4>
                                                </div>
                                                <div class="modal-body">
                                                    <ul class="list-group">
                                                        <li class="list-group-item"><b>Nama Karyawan :</b>
                                                            <?= $result['nama']; ?></li>
                                                        <li class="list-group-item"><b>Tanggal Kontrak Awal :</b>
                                                            <?= $result['kontrak_awal']; ?></li>
                                                        <li class="list-group-item"><b>Durasi :</b>
                                                            <?= $result['durasi']; ?> Bulan</li>
                                                        <li class="list-group-item"><b>Tanggal Kontrak Akhir :</b>
                                                            <?= $result['kontrak_akhir']; ?></li>
                                                        <li class="list-group-item"><b>Gaji/Upah pokok:</b>
                                                            <?= $result['gaji']; ?>/Bulan</li>
                                                    </ul>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-default"
