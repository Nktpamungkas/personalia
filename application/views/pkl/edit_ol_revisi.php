...
<section id="main-content">
    ...
    <h4><i class="fa fa-angle-right"></i><a href="<?= base_url('pkl'); ?>"> Time Attendance </a><i class="fa fa-angle-right"></i> <a href="<?= base_url('pkl'); ?>"> Form Lembur </a><i class="fa fa-angle-right"></i> Form Revisi Daftar Lembur</h4>
        <!-- FORM VALIDATION -->
        <div class="row mt">
            <div class="col-lg-12">
                <div class="form-panel">
                    <div class="form">
                        <form class="cmxform form-horizontal style-form" action="<?= base_url('pkl/edit_ol_revisi/') . $user['dept']; ?>" method="post">
                            ...
                            <div class="form-group has-warning">
                                <div class="col-lg-4">
                                    <a href="<?= base_url(); ?>pkl/add_overtime_revisi/<?= $dl->kode_lembur; ?>" class="btn btn-success" id ="btn.id">Tambah Karyawan</a>
                                </a>
                                </div>                           
                         </div>
