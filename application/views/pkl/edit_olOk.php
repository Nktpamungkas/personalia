                            ...
                            <div class="adv-table" align="center">
                                <table class="display table table-bordered">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                 <div class="checkbox">
                                                        <label title="Berdasarkan data 1">
                                                            <input type="checkbox" id="check_as_one_rest2" value=""><small><strong>Same as 1</strong></small>
                                                        </label>
                                                </div>
                                            </th>
                                        </tr>
                                    ...
                                    <?php foreach ($query_pkl as $dp) : ?>
                                        ...
                                        <td>
                                            <div class="col-sm 6">
                                                <select class="form-input input-sm rest2" name="status_tipe_lembur[]"  title="Status Lembur">
...
<script>
    ...
    ////REST SAME ALL AS NO.1
    $("table.display tbody tr:eq(0)").css("background-color", "#e7e8c3"); 
        $("#check_as_one_rest2").click(function(){
            var value_rest2 = $("table.display tbody tr:eq(0) td:eq(8) div:eq(0) select option:selected").val();

            if($("#check_as_one_rest2").prop("checked") == true){
                $("select.form-input.input-sm.rest2").val(value_rest2);
            } else if ($("#check_as_one_rest2").prop("checked") == false){
                console.log("rest not doing anything !");
            }
        });

        $("table.display tbody tr:eq(0) td:eq(8) div:eq(0) select.form-input.input-sm.rest2").change(function(){
            var value_rest2 = $("table.display tbody tr:eq(0) td:eq(8) div:eq(0) select option:selected").val();
