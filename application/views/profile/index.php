                ...
                <div class="row content-panel">
                    <div class="col-md-4 profile-text mt mb centered">
                        <div class="right-divider hidden-sm hidden-xs">
                            <h4>&nbsp;</h4>
                            <h6>&nbsp;</h6>
                            <h4><?= date('d F Y', $user['date_created']); ?></h4>
                            <h6>Member Since</h6>
                            <h4>&nbsp;</h4>
                            <h6>&nbsp;</h6>
                        </div>
                    ...
                    <div class="col-md-4 profile-text">
                        ...
                        <h6><?php
                            ...
                            ?></h6>
                        <p>Department Personalia.</p>
                        <br>
                        <p><button class="btn btn-theme"><i class="fa fa-envelope"></i>&nbsp;&nbsp;Send Email</button></p>
                    </div>
                    <!-- /col-md-4 -->
                    <div class="col-md-4 centered">
                        <div class="profile-pic">
                            <p><img src="img/profile/<?= $user['image']; ?>" class="img-circle"></p>
                            <p>
                                <button class="btn btn-theme"><i class="fa fa-check"></i> <?php
                                                                                            if ($user['is_active'] == 1) {
                                                                                                echo "Active";
                                                                                            } else {
                                                                                                echo "Not Active";
