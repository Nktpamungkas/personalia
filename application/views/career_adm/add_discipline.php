                                ...
                                <div class="col-lg-2">
                                    <select class="form-control input-sm select2" style="width: 600px" tabindex="2" data-placeholder="Pilih NIP Karyawan..."  name="no_scan" required>
                                        ...
                                        <?php
                                            $dept = $user['dept'];
                                            if ($dept == "HRD") {
                                                $queryShift = $this->db->query("SELECT * FROM tbl_makar WHERE status_aktif = 1 ORDER BY nama")->result_array();
                                            }else{
                                                $queryShift = $this->db->query("SELECT * FROM tbl_makar WHERE NOT status_aktif = 1 AND dept = '$dept' ORDER BY nama")->result_array();
                                            }
