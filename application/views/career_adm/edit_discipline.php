        ...
        <div class="row mt">
            <div class="col-lg-12">
                ...
                <div class="form-panel">
                    ...
                    <div class=" form">
                        <form class="cmxform form-horizontal style-form" action="<?= base_url('career_adm/u_career_adm'); ?>" method="post">
                            <div class="form-group">
                                <label class="control-label col-lg-2">Tanggal Surat Peringatan</label>
                                <div class="col-lg-10">
                                    <input type="hidden" name="id" value="<?= $dicipline->id; ?>">
                                    <input type="date" class="form-control input-sm" name="tgl_sp" value="<?= $dicipline->tgl_sp; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-2">
                                    <select class="form-control input-sm select2" style="width: 600px" tabindex="2" data-placeholder="Pilih NIP Karyawan..."  name="no_scan" required>
                                        ...
                                        <?php foreach ($queryShift as $dk) : ?>
                                            <option value="<?= $dk['no_scan'] ?>" <?php if ($dk['no_scan'] == $dicipline->no_scan) {
                                                echo "SELECTED";
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control input-sm" name="sp" value="<?= $dicipline->sp; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-lg-2">Alasan</label>
                                <div class="col-lg-10">
                                    <textarea class="form-control" name="alasan"><?= $dicipline->alasan; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
