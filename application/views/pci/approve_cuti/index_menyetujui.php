<section id="main-content">
    <sectio class="wrapper">
        <h4><i class="fa fa-angle-right"></i> Time Attendance <i class="fa fa-angle-right"></i> Form Approve Izin Cuti
        </h4>
        <div class="col-md-6">
        </div>
        </p>
        </div>
        <di class="row mb col-sm-12">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php
									// Mengubah nilai jam menjadi '-' jika nilainya '00:00:00'
									$jam_mulai = ($data['jam_mulai'] === '00:00:00') ? '-' : $data['jam_mulai'];
									$jam_selesai = ($data['jam_selesai'] === '00:00:00') ? '-' : $data['jam_selesai'];
									?>
                                <?php if ($data['ket'] === 'A16' || $data['ket'] === 'A17'): ?>
                                <td>
                                    <?= $data['alasan']; ?> Jam <?= $jam_mulai; ?> s/d <?= $jam_selesai; ?>
                                </td>
                                <?php else: ?>
                                <td>
                                    <?= $data['alasan']; ?>
                                ...
                                <td>
                                    <button type="button" class="edit-request-btn btn btn-info btn-xs"
                                        data-toggle="modal" data-target="#modalResign<?= $data['id']; ?>"><i
                                            class="fa fa-sign-out"></i>Approve Pengajuan Cuti</button>
                                </td>
                                <!-- Modal Resign-->
                                <div class="modal fade" id="modalResign<?= $data['id']; ?>" tabindex="-1" role="dialog"
                                    aria-labelledby="modalResign" aria-hidden="true">
                                    <form role="form" action="<?= base_url('pci/approval_cuti2/') . $user['name']; ?>"
                                        method="POST">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title" id="myModalLabel">Approve Pengajuan Cuti
                                                    </h4>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-7">
                                                            ...
                                                            <input class="form-control input-sm"
                                                                value="<?= $data['nip']; ?>" name="nip" id="nip"
                                                                type="hidden">
                                                        </div>
                                                        <?php if ($data['ket'] == "A01"): ?>
                                                        <div class="col-lg-5">
                                                            <label class="control-label col-lg-12">Sisa Cuti</label>
                                                        </div>
                                                        <div class="col-lg-7">
                                                            <input class="form-control input-sm"
                                                                value="<?= $data['sisa_cuti']; ?>" name="sisa_cuti"
                                                                id="sisa_cuti" readonly>
                                                        </div>
                                                        <div class="col-lg-5">
                                                            <label class="control-label col-lg-12">Masa berlaku
                                                                Cuti</label>
                                                        </div>
                                                        <div class="col-lg-7">
                                                            <?php if ($data['gaji'] == "atas"): ?>
                                                            <input class="form-control input-sm"
                                                                value="Januari s/d Desember" name="masa_berlaku_atas"
                                                                id="masa_berlaku_atas" readonly>
                                                            <?php else: ?>
                                                            <input class="form-control input-sm"
                                                                value="<?= $data['th_awal'] . ' s/d ' . $data['th_akhir']; ?>"
                                                                name="masa_berlaku" id="masa_berlaku" readonly>
                                                            <?php endif; ?>
                                                        </div>
                                                        <?php endif; ?>
                                                        <div class="col-lg-5">
                                                        ...
                                                        <div class="col-lg-7">
                                                            <input value="` + data[i].id + `" id="id" name="id"
                                                                type="hidden">
                                                            <input class="form-control input-sm"
