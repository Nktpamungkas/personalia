                ...
                <div class="adv-table">
                    ...
                    $(document).ready(function() {
                        ...
                        function tampil_data_employee() {
                            $.ajax({
                                type: 'ajax',
                                url: '<?= base_url() ?>pci/data_approve_cuti_menyetujui',
                                async: false,
                                dataType: 'json',
                                        ...
                                        html +=
                                            ...
                                            data[i].id + `"><i class="fa fa-sign-out"></i>Approve Pengajuan Dinas</button>
													...
													<div class="modal fade" id="modalResign` + data[i].id + `" tabindex="-1" role="dialog" aria-labelledby="modalResign" aria-hidden="true">
														<form role="form" action="<?= base_url('pci/approval_cuti2/') . $user['name']; ?>" method="POST">
																...
																<div class="modal-body">
																	<div class="form-group">
																		<div class="col-lg-5">
																			...
																			<div class="col-lg-7">
																				<input type="radio" name="ket_approval_2" id="ket_approval_2" value="Approved"> Approved <br/>
																				<input type="radio" name="ket_approval_2" id="ket_approval_2" value="Rejected"> Rejected
																				<input class="form-control input-sm" value="` + data[i].atasan2 + ` / <?= $user['no_scan']; ?> / <?= date('Y-m-d h:i:s'); ?>" name="getalldata" type="hidden">
																				<input class="form-control input-sm" value="` + data[i].atasan2 + `" name="user_approval2" type="hidden">
																				<input class="form-control input-sm" value="` + data[i].jabatan + `" name="jabatan" type="hidden">
