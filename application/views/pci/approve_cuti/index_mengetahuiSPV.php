<section id="main-content">
	<t class="wrapper">
		<h4><i class="fa fa-angle-right"></i> Time Attendance <i class="fa fa-angle-right"></i> Form Pengajuan Cuti
		</h4>
					...
					<script type="text/javascript">
						$(document).ready(function () {
							...
							function tampil_data_employee() {
								$.ajax({
									type: 'ajax',
									url: '<?= base_url() ?>pci/data_approve_cuti_mengetahuiSPV',
									async: false,
									dataType: 'json',
									success: function (data) {
										...
										for (var i = 0; i < data.length; i++) {
											html += '<tr class="gradeX">' +
												...
												'<td>' + data[i].alasan + '</td>' +
												`<td><button type="button" class="edit-request-btn btn btn-info btn-xs" data-toggle="modal" data-target="#modalResign` +
												...
												<div class="modal fade" id="modalResign` + data[i].id + `" tabindex="-1" role="dialog" aria-labelledby="modalResign" aria-hidden="true">
													<form role="form" action="<?= base_url('pci/approval_cuti1SPV/') . $user['name']; ?>" method="POST">
															...
															<div class="modal-content">
																...
																<div class="modal-body">
																	<div class="form-group">
																		...
																		<div class="col-lg-7">
																			<input type="radio" name="ket_approval_1" value="Approved"> Approved <br/>
																			<input type="radio" name="ket_approval_1" value="Rejected"> Rejected
																			<input class="form-control input-sm" value="` + data[i].atasan1 + ` / ` + data[i].no_scan_atasan_1 + ` / <?= date('Y-m-d h:i:s'); ?>" name="getalldata" type="Text">
																			<input class="form-control input-sm" value="` + data[i].atasan1 + `" name="user_approval_1" type="hidden">
