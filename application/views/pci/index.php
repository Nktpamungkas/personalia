    ...
    <section class="wrapper">
        ...
        <div class="col-md-6">
            <p>
                ...
                <a href="<?= base_url('pci/add_Request'); ?>" class="btn btn-info"><i
                        class=" fa fa-plus"></i>&nbsp;&nbsp;Add Form Izin Cuti</a>
                <?php else: ?>
                <a href="<?= base_url('pci/index_all'); ?>" class="btn btn-warning"><i
                        class=" fa fa-list-alt"></i>&nbsp;&nbsp;Show Request for Izin Cuti</a>
                <a href="<?= base_url('pci/index_dinas'); ?>" class="btn btn-warning"><i
                        class=" fa fa-list-alt"></i>&nbsp;&nbsp;Show Request Dinas</a>
                <a href="<?= base_url('pci/add_Request'); ?>" class="btn btn-info"><i
                        class=" fa fa-plus"></i>&nbsp;&nbsp;Add Form Izin Cuti</a>
                <a href="#" data-toggle="modal" data-target="#modalExportdept" class="btn btn-success">Export to
                    Excel</a>
                <?php endif ?>
            </p>
        </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <label>
                                            ...
                                            <input type="text" value="<?= $user['dept']; ?>"
                                                onkeyup="this.value = this.value.toUpperCase();" name="dept" hidden>
                                        </label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered"
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <li class="dropdown" style="list-style-type:none;">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="#"
                                                    style="color: grey; text-decoration: line-through; font-size:13px;"
                                                    title="Cetak tidak aktif">Cetak</a></li>
                                            <li class="divider"></li>
                                            <li><a href="#"
                                                    style="color: grey; text-decoration: line-through; font-size:13px;"
                                                    title="Hapus tidak aktif">Hapus</a></li>
                                        </ul>
                                        <?php elseif ($result['status'] == "Printed"): ?>
                                        <ul class="dropdown-menu">
                                            <!-- <li><a href="#" style="color: grey; text-decoration: line-through; font-size:13px;" title="Ubah tidak aktif">Ubah</a></li> -->
                                            <li><a href="<?= base_url(); ?>pci/print_izin_cuti/<?= $result['id']; ?>"
                                                    style="color: black; font-size:13px;" title="Cetak">Cetak</a></li>
                                            <li class="divider"></li>
                                            <li><a href="#"
                                                    style="color: grey; text-decoration: line-through; font-size:13px;"
                                                    title="Hapus tidak aktif">Hapus</a></li>
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="<?= base_url(); ?>pci/print_izin_cuti/<?= $result['id']; ?>"
                                                    style="color: black; font-size:13px;">Cetak</a></li>
                                            <li class="divider"></li>
                                            <li><a href="#" style="color: black; font-size:13px;"
                                                    data-target="#modal-delete<?= $result['id']; ?>"
                                                    data-toggle="modal">Hapus</a></li>
                                        </ul>
                                        <div class="modal fade" id="modal-delete<?= $result['id']; ?>">
                                            <div class="modal-dialog ">
                                                <div class="modal-content">
                                                    <form class="form-horizontal"
                                                        action="<?= base_url(); ?>pci/delete/<?= $result['id']; ?>"
                                                        method="post">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal"
                                                                aria-label="Close">
                                                                <span aria-hidden="true">&times;</span></button>
                                                            <h4 class="modal-title" id="myModalLabel">Apakah anda yakin
                                                                ingin mengahapus data ini?</h4>
                                                        </div>
                                                        <div class="modal-footer">
                                ...
                                <td><a href="#"
                                        style="text-decoration: underline;"><?= $result['kode_cuti'] . '-' . sprintf("%07s", $result['id']); ?></a>
                                </td>
