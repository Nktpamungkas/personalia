                        ...
                        <form class="cmxform form-horizontal style-form"
                            ...
                            <div class="form-group">
                                ...
                                <label class="control-label col-lg-2"><input class="form-control input-sm col-lg-2"
                                        ...
                                        id="disetujui_nama_1" type="hidden" required>
                                    <input class="form-control input-sm col-lg-2" id="label_disetujui_nama_1"
                                        readonly></input></label>
                                <label class="control-label col-lg-2"><input class="form-control input-sm col-lg-2"
                                        value="<?= set_value('disetujui_nama_2'); ?>" name="disetujui_nama_2"
                                        id="disetujui_nama_2" type="hidden" required>
                                    <input class="form-control input-sm col-lg-2" id="label_disetujui_nama_2"
                                        readonly></input></label>
                                <label class="control-label col-lg-2"><input class="form-control input-sm col-lg-2"
                                        value="STEFANUS PRANJANA" name="mengetahui_nama" id="mengetahui_nama"
                                        type="hidden" required>
                                    <span id="label_mengetahui_nama"></span></label>
                            </div>
                            <div class="form-group">
                                ...
                                <label class="control-label col-lg-2"><input class="form-control input-sm col-lg-2"
                                        ...
                                        id="disetujui_jabatan_1" type="hidden">
                                    <input class="form-control input-sm col-lg-2" id="label_disetujui_jabatan_1"
                                        readonly></input></label>
                                <label class="control-label col-lg-2"><input class="form-control input-sm col-lg-2"
                                        value="<?= set_value('disetujui_jabatan_2'); ?>" name="disetujui_jabatan_2"
                                        id="disetujui_jabatan_2" type="hidden">
                                    <input class="form-control input-sm col-lg-2" id="label_disetujui_jabatan_2"
                                        readonly></input></label>
                                <label class="control-label col-lg-2"><input class="form-control input-sm col-lg-2"
                                        value="HRD MANAGER" name="mengetahui_jabatan" id="mengetahui_jabatan"
                                        type="hidden">
                                    <span id="label_mengetahui_jabatan"></span></label>
                            </div>
                            <div class="form-group">
