        ...
        success: function(data){
            ...
            document.getElementById('pemohon_jabatan').value = data[0].jabatan;
                if (data[0].status_karyawan === "Tetap") {
                    ...
                    document.getElementById("tgl_mulai").setAttribute("min", yyyy+'-'+mo_awal+'-'+da_awal);
                    document.getElementById("tgl_mulai").setAttribute("max", ye_akhir+'-'+mo_akhir+'-'+da_akhir);
                    document.getElementById("tgl_selesai").setAttribute("min", yyyy+'-'+mo_awal+'-'+da_awal);
                    document.getElementById("tgl_selesai").setAttribute("max", ye_akhir+'-'+mo_akhir+'-'+da_akhir);

                    if (data[0].sisa_cuti) {
                        document.getElementById('sisa_cuti').innerHTML  = "Sisa cuti karyawan sebanyak <b>" + data[0].sisa_cuti + " Hari.</b> Periode pengambilan cuti yaitu bulan <b>" + data[0].awal + "</b> s/d bulan <b>" + data[0].akhir +".</b> Diluar periode bulan yang sudah ditentukan, maka cuti tidak berlaku (ganti keterangan menjadi izin)."
                    } else {
                        document.getElementById('sisa_cuti').innerHTML  = "Sisa cuti karyawan belum di update. Silahkan hubungi Departemen HRD/Personalia."
                    }
                } else {
        ...
        <div class="row mt">
            <div class="col-lg-12">
                ...
                <div class="form-panel">
                    <div class="form">
                        <form class="cmxform form-horizontal style-form" action="<?= base_url('pci/edit/') . $user['dept']; ?>" method="post">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <select class="form-control input-sm select2" data-placeholder="Pilih NIP Karyawan..." tabindex="2" name="no_scan" id="no_scan">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control input-sm select2" data-placeholder="Pilih Personnel Pengganti..." tabindex="2" name="pengganti_kerja" required>
                                        <option value="" disabled selected></option>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-2">
                                    <input type="date" name="tgl_mulai" class="form-control input-sm" id="tgl_mulai" value="<?= $dpci->tgl_mulai; ?>" required>
                                </div>
                                <label class="control-label col-lg-2">Lama Izin/Cuti</label>
                                <div class="col-lg-1">
                                    <input type="text" name="lama_izin" class="form-control input-sm" id="lama_izin" value="<?= $dpci->lama_izin; ?>" required>
                                </div>
                                <div class="col-lg-1">
                                ...
                                <div class="col-lg-2">
                                    <input type="date" name="tgl_selesai" class="form-control input-sm" value="<?= $dpci->tgl_selesai; ?>" id="tgl_selesai" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-lg-2">Alasan</label>
                                <div class="col-lg-10">
                                    <textarea class="form-control input-sm" name="alasan"><?= $dpci->alasan; ?></textarea>
                                    <input type="hidden" name="id" value="<?= $dpci->id; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <label class="control-label col-lg-2"><input class="form-control input-sm col-lg-2" value="<?= $dpci->pemohon_nama; ?>" name="pemohon_nama" type="text" required></label>
                                <label class="control-label col-lg-2"><input class="form-control input-sm col-lg-2" value="<?= $dpci->disetujui_nama_1; ?>" name="disetujui_nama_1" type="text" required></label>
                                <label class="control-label col-lg-2"><input class="form-control input-sm col-lg-2" value="<?= $dpci->disetujui_nama_2; ?>" name="disetujui_nama_2" type="text" required></label>
                                <label class="control-label col-lg-2"><input class="form-control input-sm col-lg-2" value="<?= $dpci->mengetahui_nama; ?>" name="mengetahui_nama" type="text" required></label>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-lg-2">Jabatan</label>
                                <label class="control-label col-lg-2"><input class="form-control input-sm col-lg-2" value="<?= $dpci->pemohon_jabatan; ?>" name="pemohon_jabatan" type="text" required></label>
                                <label class="control-label col-lg-2"><input class="form-control input-sm col-lg-2" value="<?= $dpci->disetujui_jabatan_1; ?>" name="disetujui_jabatan_1" type="text" required></label>
                                <label class="control-label col-lg-2"><input class="form-control input-sm col-lg-2" value="<?= $dpci->disetujui_jabatan_2; ?>" name="disetujui_jabatan_2" type="text" required></label>
                                <label class="control-label col-lg-2"><input class="form-control input-sm col-lg-2" value="<?= $dpci->mengetahui_jabatan; ?>" name="mengetahui_jabatan" type="text" required></label>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-lg-2">Tanggal</label>
                                <label class="control-label col-lg-2"><input class="form-control input-sm col-lg-2" value="<?= $dpci->tgl_surat_pemohon; ?>" name="tgl_surat_pemohon" type="date" required></label>
                                <!-- PEMBATASAN HAK AKSES EDIT -->
                                <?php if ($user['name'] == "Wati" || $user['name'] == "Dessi" ) : ?>
                                    <label class="control-label col-lg-6"><input class="form-control input-sm col-lg-2" value="<?= $dpci->tgl_diset_mengetehui; ?>" name="tgl_diset_mengetehui" type="date" required></label>
                                <?php else : ?>
                                    <label class="control-label col-lg-6"><input class="form-control input-sm col-lg-2" value="<?= $dpci->tgl_diset_mengetehui; ?>" name="tgl_diset_mengetehui" type="date" readonly><i>*Yg bisa merubah hanya Mba Wati atau Dessi.</i></label>                                    
                                <?php endif; ?>
                            </div>
                            <div class="form-group">
