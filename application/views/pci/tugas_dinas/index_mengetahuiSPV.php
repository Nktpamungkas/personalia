																...
																<div class="modal-body">
																	<div class="form-group">
																		...
																		<div class="col-lg-7">
																			...
																			<input class="form-control input-sm" value="<?= $user['name']; ?> / <?= $user['no_scan']; ?> / <?= date('Y-m-d h:i:s'); ?>" name="getalldata" type="hidden">
																			<input class="form-control input-sm" value="` + data[i].nama_atasan + `" name="user_approval_1" type="hidden">
																			<input class="form-control input-sm" value="` + data[i].jabatan_atasan1 + `" name="jabatan_1" type="hidden">
