																...
																<div class="modal-body">
																	<div class="form-group">
																		<div class="col-lg-5">
																			...
																			<div class="col-lg-7">
																				<input type="radio" name="ket_approval_1" id="ket_approval_1" value="Approved"> Approved <br/>
																				<input type="radio" name="ket_approval_1" id="ket_approval_1" value="Rejected"> Rejected
																				<input class="form-control input-sm" value="<?= $user['name']; ?> / <?= $user['name']; ?> / <?= date('Y-m-d h:i:s'); ?>" name="getalldata" type="hidden">
																				<input class="form-control input-sm" value="` + data[i].nama_atasan2 + `" name="user_approval" type="hidden">
																				<input class="form-control input-sm" value="` + data[i].jabatan_atasan2 + `" name="jabatan_1" type="hidden">
