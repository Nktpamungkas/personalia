<section id="main-content">
	<section class="wrapper">
		...
		<div class="col-md-6">
			<p>
				<?php if ($Belum_ver): ?>
				<form action="<?= base_url('pci/index_dinas'); ?>" method="POST">
					...
					<table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered"
						...
						<tbody>
							...
							$query = $this->db->query("SELECT a.id, a.kode_cuti,
											...
											a.status_approval_1 ,
											a.status_approval_2,
											a.status_approval as status_aproval_3
										FROM
											permohonan_izin_cuti a
											LEFT JOIN ( SELECT * FROM tbl_makar ) b ON a.nip = b.no_scan 
										WHERE
										a.status_approval_1 in('Approved','-') and a.status_approval_2 in('Approved','-') and a.status_approval ='Approved' AND a.kode_cuti LIKE '%FIC%'
