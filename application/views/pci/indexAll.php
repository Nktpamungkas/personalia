                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="table-indexAll-pci-ver">
                        ...
                        <?php
                            ...
                            <?php foreach($query AS $data): ?>
                                <tr>
                                    <td><a href="#" style="text-decoration: underline;"><?= $data['kode_cuti'].'-'.sprintf("%07s", $data['id']); ?></a></td>
                                    ...
                                    <td><?= $data['alasan']; ?></td>
                                    <!-- <td><?php if($data['status'] == "Verifikasi"){ echo '<span class="fa fa-check-circle">Terverifikasi</span>';} ?></td> -->
                                    <td>
