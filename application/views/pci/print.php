		...
		<tbody>
			...
			<tr class="row19">
				...
				<?php elseif ($dpci->ket == "A15" && $dpci->role_id == 3): ?>
					<td class="column4 style16 s style16" colspan="3"><?= $dpci->disetujui_nama_2; ?></td>
				<?php elseif ($dpci->ket == "A15" && $dpci->role_id == 2): ?>
					<td class="column4 style16 s style16" colspan="3"><?= htmlspecialchars($dpci->APD); ?></td>
				<?php elseif ($dpci->ket == "A15" && $dpci->role_id == 4 || $dpci->role_id == 12): ?>
					<td class="column4 style16 s style16" colspan="3"><?= $dpci->disetujui_nama_2; ?></td>
				<?php endif; ?>
				<?php if ($dpci->ket !== "A15"): ?>
			...
			<tr class="row20">
				...
				<?php elseif ($dpci->ket == "A15" && $dpci->role_id == 4 || $dpci->role_id == 12): ?>
					<td class="column4 style16 s style16" colspan="2"></td>
				<?php elseif ($dpci->ket == "A15" && $dpci->role_id == 3): ?>
					<td class="column4 style16 s style16" colspan="2"></td>
				<?php elseif ($dpci->ket == "A15" && $dpci->role_id == 2): ?>
					<td class="column4 style16 s style16" colspan="2"></td>
			...
			<tr class="row20">
				...
				<?php elseif ($dpci->ket == "A15" && $dpci->role_id == 2): ?>
					<td class="column4 style16 s style16" colspan="3"><?= $dpci->ftgl_approval; ?></td>
				<?php elseif ($dpci->ket == "A15" && $dpci->role_id == 4 || $dpci->role_id == 12): ?>
					<td class="column4 style16 s style16" colspan="3"><?= $dpci->ftgl_approval_2; ?></td>
				<?php endif; ?>
				...
				<?php elseif ($dpci->ket == "A15" && $dpci->role_id == 3): ?>
					<td class="column4 style16 s style16" colspan="2"><?= $dpci->ftgl_approval; ?></td>
				<?php elseif ($dpci->ket == "A15" && $dpci->role_id == 4 || $dpci->role_id == 12): ?>
					<td class="column4 style16 s style16" colspan="2"></td>
				<?php elseif ($dpci->ket == "A15" && $dpci->role_id == 2): ?>
					<td class="column4 style16 s style16" colspan="2"><?= $dpci->ftgl_approval; ?></td>
			...
			<tr class="row20">
				...
				<?php elseif ($dpci->ket == "A15" && $dpci->role_id == "2" && $dpci->status_approval == "Approved"): ?>
					<td class="column6 style17 s style17" colspan="3">
						<center>
							<?php
							// Include library QRcode
