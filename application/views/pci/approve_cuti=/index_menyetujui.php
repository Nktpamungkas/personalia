                                    ...
                                    for (i = 0; i < data.length; i++) {
                                        html +=
                                            ...
                                            .fkode_cuti + '/' + data[i].nama + '/' + data[i].nip + `/<?= date('Y-m-d h:i:s'); ?>" name="getalldata" type="hidden">
																				<input class="form-control input-sm" value="` + data[i].atasan2 + `" name="user_approval2" type="text">
																				<input class="form-control input-sm" value="` + data[i].jabatan + `" name="jabatan" type="text">
