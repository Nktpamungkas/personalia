...
<section id="main-content">
    ...
    <h4><i class="fa fa-angle-right"></i><a href="<?= base_url('pkl2'); ?>"> Time Attendance </a><i class="fa fa-angle-right"></i> <a href="<?= base_url('pkl2'); ?>"> Form Lembur </a><i class="fa fa-angle-right"></i> Edit Form Daftar Lembur</h4>
        <!-- FORM VALIDATION -->
        <div class="row mt">
            <div class="col-lg-12">
                <div class="form-panel">
                    <div class="form">
                        <form class="cmxform form-horizontal style-form" action="<?= base_url('pkl2/edit_ol/') . $user['dept']; ?>" method="post">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            // START SERACH NAMA
                                                $('#no_absen<?= $dp['no_absen']; ?>').change(function(){
                                                    ...
                                                    $.ajax ({
                                                        type: 'POST',
                                                        url: '<?= base_url()."pkl2/search_nama" ?>/' + _nama,
                                                        dataType: 'json',
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                    ...
                                    <?php if($user['dept'] == "HRD") : ?>
                                        <a href="<?= base_url('pkl2/index_all'); ?>" class="btn btn-theme04">Cancel</a>
                                    <?php else : ?>
