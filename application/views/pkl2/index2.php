        ...
        <div class="col-md-6">
            <p>
                <?php if($user['dept'] != 'HRD') : ?>  
                    <a href="<?= base_url('pkl2/add_Request'); ?>" class="btn btn-info"><i class=" fa fa-plus"></i>&nbsp;&nbsp;Masukan nama karyawan lembur</a>
                    <!-- <i href="#" class="btn btn-warning"><i class=" fa fa-frown-o"></i>&nbsp;&nbsp;<i>Under Maintenance</i></a> -->
                <?php else : ?>
                    <a href="<?= base_url('pkl2/index_all'); ?>" class="btn btn-warning"><i class=" fa fa-list-alt"></i>&nbsp;&nbsp;Tampilkan Semua Daftar Lembur</a>
                    <a href="<?= base_url('pkl2/add_Request'); ?>" class="btn btn-info"><i class=" fa fa-plus"></i>&nbsp;&nbsp;Add Form Lembur</a>
                            ...
                            <tr>
                                <td>
                                    <li class="dropdown" style="list-style-type:none;">
                                        ...
                                        <?php else : ?>
                                            <ul class="dropdown-menu">
                                                <li><a href="<?= base_url(); ?>pkl2/edit_request/<?= $result['kode_lembur']; ?>" style="font-size:13px;">Ubah nama karyawan</a></li>
                                                <!-- <li><a href="<?= base_url(); ?>pkl/print_permohonan/<?= $result['kode_lembur']; ?>" style="font-size:13px;">Print permohonan kerja lembur</a></li> -->
                                                <li><a href="<?= base_url(); ?>pkl2/tambah/<?= $result['kode_lembur']; ?>" style="font-size:13px;">Tambah nama karyawan lembur</a></li>
                                                <li class="divider"></li>
                                                <!-- <li class="divider"></li> -->
                                                <li><a href="<?= base_url(); ?>pkl2/add_overtime_list/<?= $result['kode_lembur']; ?>" style="font-size:13px;"><b>Buat surat perintah lembur</b></a></li>
                                                <li><a href="<?= base_url(); ?>pkl2/print_daftar_lembur/<?= $result['kode_lembur']; ?>" style="font-size:13px;"><b>Print surat perintah lembur</b></a></li>
                                                <li class="divider"><hr></li>
                                                <!-- <li><a href="<?= base_url(); ?>pkl/hapus_permohonan_lembur/<?= $result['kode_lembur']; ?>" style="font-size:13px;">Hapus Permohonan Lembur</a></li> -->
                                                <li><a href="<?= base_url(); ?>pkl2/hapus_daftar_lembur/<?= $result['kode_lembur']; ?>" style="font-size:13px;">Hapus surat perintah lembur</a></li>
                                            </ul>
                                        <?php endif; ?>
                                    </li>
                                </td>
