            <div class="col-sm-9">
                <div class="showback">
                    ...
                    <div class="btn-group btn-group-justified">
                        ...
                        <div class="btn-group">
                            <a href="<?= base_url('history/new_employee1'); ?>" class="btn btn-theme01">New employee 1</a>
                        </div>
                        <div class="btn-group">
                    ...
                    <div class="row mt">
                        <div class="col-lg-12">
                            <h4><i class="fa fa-angle-right"></i> Log New Employee</h4>
                                ...
                                <div class="adv-table">
                                    <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $log = "SELECT * FROM log_new_employee_1 ORDER BY id DESC";
