            <div class="col-sm-9">
                <div class="showback">
                    ...
                    <div class="btn-group btn-group-justified">
                        ...
                        <div class="btn-group">
                            <a href="<?= base_url('history/update_employee'); ?>" class="btn btn-theme01">Update employee</a>
                        </div>
                    </div>
                    <br>
                    <div class="btn-group btn-group-justified">
                    ...
                    <div class="row mt">
                        <div class="col-lg-12">
                            <h4><i class="fa fa-angle-right"></i> Log update employee</h4>
                                ...
                                <div class="adv-table">
                                    <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $log = "SELECT * FROM log_update_employee_1 ORDER BY id DESC";
