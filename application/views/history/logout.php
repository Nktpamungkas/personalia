            <div class="col-sm-9">
                ...
                <div class="btn-group btn-group-justified">
                    ...
                    <div class="btn-group">
                        <a href="<?= base_url('history/logout'); ?>" class="btn btn-theme01">Logout</a>
                    </div>
                    <div class="btn-group">
                ...
                <div class="row mt">
                    <div class="col-lg-12">
                        <h4><i class="fa fa-angle-right"></i> Log Logout</h4>
                        <div class="content-panel">
                            <div class="adv-table">
                                <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="table-h-logout">
                                    <thead>
                                        <tr>
                                            <th>Date</th>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $log = "SELECT * FROM log_logout ORDER BY `date_logout` DESC";
                                        $dataLog = $this->db->query($log)->result_array();
                                        ?>
                                        <?php foreach ($dataLog as $dl) : ?>
                                        <tr class="gradeX">
                                            <td><?= date('d F Y, H:i:s', $dl['date_logout']); ?></td>
                                            <td><?= $dl['username']; ?></td>
                                            <td><?= $dl['keterangan']; ?></td>
                                        </tr> 
                                        <?php endforeach; ?>
