                ...
                <div class="col-md-4 col-sm-8 mb">
                    <div class="grey-panel pn donut-chart">
                        <div class="grey-header">
                            <h5><b>MALE EMPLOYEE</b></h5>
                        </div>
                        <canvas id="serverstatus01" height="120" width="120"></canvas>
                        <?php 
                        $aktiveL = $this->db->query("SELECT Count(*) AS jml FROM tbl_makar WHERE status_aktif = '1' AND jenis_kelamin='Laki'")->row();
                        $nonAktiveL = $this->db->query("SELECT Count(*) AS jml FROM tbl_makar WHERE status_aktif = '0' AND jenis_kelamin='Laki'")->row();
                        ?>
                        <script>
                            var doughnutData = [{
                            value: <?= $aktiveL->jml; ?>,
                    ...
                    <div class="col-md-4 col-sm-4 mb">
                        <div class="grey-panel pn donut-chart">
                            <div class="grey-header">
                                <h5><b>FEMALE EMPLOYEE</b></h5>
                            </div>
                            <canvas id="serverstatus02" height="120" width="120"></canvas>
                            <?php 
                            $aktiveP = $this->db->query("SELECT Count(*) AS jml FROM tbl_makar WHERE status_aktif = '1' AND jenis_kelamin='Wanita'")->row();
                            $nonAktiveP = $this->db->query("SELECT Count(*) AS jml FROM tbl_makar WHERE status_aktif = '0' AND jenis_kelamin='Wanita'")->row();
                            ?>
                            <script>
                                var doughnutData = [{
                                value: <?= $aktiveP->jml; ?>,
            ...
            <div class="col-lg-3 ds">
                <div class="donut-main">
                    ...
                    <?php 
                        ...
                        $nonAktive = $this->db->query("SELECT Count(*) AS jml FROM tbl_makar WHERE status_aktif = '0'")->row();
                    ?>
