    ...
    <section class="wrapper">
        ...
        <div class="row">
                    ...
                    <div class="darkblue-panel pn">
                        ...
                        <footer>
                            <div class="centered">
                                ...
                                <h3 id="important" style="display: inline;"><span
                                        style="color: red;"><?= $jumlahKaryawanBaru; ?></span></h3>
                                <script>
                                ...
                                blink
                                    (); // Panggil fungsi blink untuk membuat teks berkelap-kelip jika jumlahKaryawanBaru tidak sama dengan 0
                                </script>
                    ...
                    <div class="darkblue-panel pn">
                        ...
                        <footer>
                            <div class="centered">
                                ...
                                <h3 id="important2" style="display: inline;"><span
                                        style="color: red;"><?= $jumlahVerifikasi; ?></span></h3>
                                <script>
                                // Fungsi untuk membuat teks berkelap-kelip
                                function blink2() {
                        ...
                        <div class="row mt">
                            <div class="col-md-3 col-sm-8 mb">
                                <div class="grey-panel pn donut-chart">
                                    ...
                                    <?php
										$aktiveL = $this->db->query("SELECT Count(*) AS jml FROM tbl_makar WHERE status_aktif = '1' AND jenis_kelamin='Laki' ")->row();
										?>
                                    <div class="row">
                            ...
                            <div class="col-md-6 col-sm-4 mb">
                                <div class="white-panel pn">
                                    ...
                                    <p><img src="<?= base_url('img/profile/') . $user['image']; ?>" class="img-circle"
                                            width="50"></p>
                            ...
                            <div class="col-md-3 col-sm-8 mb">
                                <div class="grey-panel pn donut-chart">
                                    ...
                                    <?php
										$aktiveP = $this->db->query("SELECT Count(*) AS jml FROM tbl_makar WHERE status_aktif = '1' AND jenis_kelamin='Wanita' ")->row();
										?>
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12">
                                            <h2><?= $aktiveP->jml; ?></h2>
            ...
            <div class="col-lg-3 ds">
                ...
                <?php
					$dataLogged = $this->db->query("SELECT *
										from
											`user` u
										where
											u.logged = 1
											and
					u.role_id in (1, 13, 5, 2, 8)")->result_array();
					?>
                ...
                <div class="desc">
                    ...
                    <div class="details">
                        <p>
                            <a href="#" data-toggle="modal" data-target="#modalName<?= $dl['id']; ?>"
                                style="color: black;"><?= $dl['name']; ?></a><br />
                            <muted>Available</muted>
                        </p>
                    </div>
                </div>
                <div class="modal fade" id="modalName<?= $dl['id']; ?>" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <div class="thumb">
                                        <img class="img-circle" src="<?= base_url() ?>img/<?= $dl['image']; ?>"
                ...
                <div class='row'>
                    <div class="col-md-12 mb">
                        ...
                        <div class="image" style="text-align: center;">
                            <img src="<?= base_url() ?>img/ITTI_Logo Option.png"
                                style="width: auto; height: auto; max-width: 100%;" alt="Logo ITTI">
                        </div>
                ...
                <?php
					$dataLogged = $this->db->query("SELECT *
										...
										where
											u.logged = 1
											and
					u.role_id in (1, 13, 5, 2, 8,4)")->result_array();
					?>
                <?php foreach ($dataLogged as $dl): ?>
                <div class="desc">
                    <div class="thumb">
