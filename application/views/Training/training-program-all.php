    ...
    <section class="wrapper">
        ...
        <div class="mb col-lg-12">
            <?php if($user['dept'] == "HRD" OR $user['dept'] == "GAC" OR $user['dept'] == "DIT") : ?>
                <p>
                    <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#Hapus"><i class=" fa fa-plus"></i>&nbsp;&nbsp;Buat Training Program</a>
                    <a href="<?= base_url(); ?>Training/index_training_program" class="btn btn-default btn-sm"><i class=" fa fa-eye"></i>&nbsp;&nbsp;Kembali</a>
                    <!-- Modal -->
                        ...
                        <tbody>
                            <?php 
                                ...
                                $query = $this->db->query("SELECT a.id, a.kode_training, b.nama_training, a.dept, a.tanggal_training
                                                            ...
                                                            JOIN (SELECT * FROM training b ) b ON b.id = a.kode_training")->result_array(); 
                            ?>
