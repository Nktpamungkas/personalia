                ...
                <div id="sidebar" class="nav-collapse ">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 6) : ?>
                            <li class="sub-menu">
                                <a <?php if ($title == "Dashboard" || $title == "Dashboard Karyawan Baru" || $title == "Karyawan Habis Kontrak" || $title == "Data Karyawan Kedisiplinan" || $title == "Data Karyawan Keluar" || $title == "Data Karyawan Ulang Tahun" || $title == "Data Karyawan Masa Percobaan") {
                                        echo 'class="active"';
                                    } ?> href="javascript:;">
                        ...
                        <li class="sub-menu">
                            <?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5) : ?>
                                <a href="javascript:;" <?php if ($title == "Career Administration | Transision" || $title == "Career Administration | Report") {
                                                            echo 'class="active"';
                                                        } ?>>
