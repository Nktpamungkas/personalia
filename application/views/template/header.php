								...
								<ul class="sub">
									<li <?php if ($title == "Dashboard") {
										echo 'class="active"';
											...
											href="<?= base_url('home'); ?>">Headcount Karyawan</a></li>
									<li <?php if ($title == "Dashboard Karyawan Baru") {
										echo 'class="active"';
									} ?>><a
											href="<?= base_url('home/karyawanbaru'); ?>">Karyawan Baru</a></li>
									...
									<li <?php if ($title == "Karyawan Habis Kontrak") {
										echo 'class="active"';
											...
											href="<?= base_url('home/habiskontrak'); ?>">Habis Kontrak</a></li>
									...
									<li <?php if ($title == "Data Karyawan Kedisiplinan") {
										echo 'class="active"';
											...
											href="<?= base_url('home/kedisiplinan'); ?>">Surat Peringatan</a></li>
									<li <?php if ($title == "Data Karyawan Keluar") {
										echo 'class="active"';
									} ?>><a
											href="<?= base_url('home/keluar'); ?>">Karyawan Keluar</a></li>
									<li <?php if ($title == "Data Karyawan Ulang Tahun") {
										echo 'class="active"';
									} ?>><a
											href="<?= base_url('home/ulangtahun'); ?>">Karyawan Ulang Tahun</a>
									</li>
									...
									<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 6 || $role_id == 13): ?>
										<li <?php if ($title == "Employee Information") {
											echo 'class="active"';
												...
												href="<?= base_url('data_karyawan'); ?>">Employee Information</a>
										</li>
									<?php endif; ?>
									...
									<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 6 || $role_id == 13): ?>
										<li <?php if ($title == "Employee Dept. Information") {
											echo 'class="active"';
												...
												href="<?= base_url('data_karyawan/per_dpt'); ?>">Employee Dept.
												Information</a></li>
									<?php endif; ?>
									...
									<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 6 || $role_id == 13): ?>
										<li <?php if ($title == "PKWT") {
											echo 'class="active"';
												...
												href="<?= base_url('PKWT/index'); ?>">PKWT</a></li>
									<?php endif; ?>
									...
									<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 13): ?>
										<li <?php if ($title == "Career Administration | Discipline") {
											echo 'class="active"';
												...
												href="<?= base_url('career_adm/discipline'); ?>">Surat
												Peringatan</a></li>
									<?php endif; ?>
									...
									<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 6 || $role_id == 7 || $role_id == 13): ?>
										<li <?php if ($title == "Employee | Data Seragam ") {
											echo 'class="active"';
												...
												href="<?= base_url('Data_karyawan/seragam'); ?>">Data Seragam</a>
										</li>
									<?php endif; ?>
								</ul>
							</li>
									...
									<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 6 || $role_id == 13): ?>
										<li <?php if ($title == "Recruitment | Permohonan") {
											echo 'class="active"';
												...
												href="<?= base_url('Recruitment/index_permohonan'); ?>">Permohonan</a></li>
									<?php endif; ?>
									...
									<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 6 || $role_id == 13): ?>
										<li <?php if ($title == "Recruitment | Seleksi") {
											echo 'class="active"';
												...
												href="<?= base_url('Recruitment/index_seleksi'); ?>">Seleksi</a>
										</li>
									<?php endif; ?>
									<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 6 || $role_id == 13): ?>
										<li <?php if ($title == "Recruitment | Exit Interview") {
											echo 'class="active"';
												...
												href="<?= base_url('Recruitment/List_form_exit_interview'); ?>">Exit Interview</a>
										</li>
									<?php endif; ?>
								</ul>
							</li>
								...
								<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 13): ?>
									<li <?php if ($title == "Career Administration | Transision") {
										echo 'class="active"';
											...
											href="<?= base_url('career_adm/transision'); ?>">Career Transision</a>
									</li>
								<?php endif; ?>
								...
								<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 13): ?>
									<li <?php if ($title == "Career Administration | Report") {
										echo 'class="active"';
											...
											href="<?= base_url('career_adm/report'); ?>">Career Report</a></li>
								<?php endif; ?>
							</ul>
						</li>
						<li class="sub-menu">
								...
								<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 6 || $role_id == 7 || $role_id == 13): ?>
									<li <?php if ($title == "Time Attendance | Izin Cuti") {
										echo 'class="active"';
											...
											href="<?= base_url('pci'); ?>">Izin Cuti</a></li>
								<?php endif; ?>
								...
								<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 6 || $role_id == 13): ?>
									<li <?php if ($title == "Time Attendance | Laporan Absen") {
										echo 'class="active"';
											...
											href="<?= base_url('pci/laporan_absen'); ?>">Laporan Absen</a> </li>
								<?php endif; ?>
								...
								<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 6 || $role_id == 13): ?>
									<li <?php if ($title == "Time Attendance | Generate Cuti") {
										echo 'class="active"';
											...
											href="<?= base_url('pci/generate_cuti'); ?>">Laporan Sisa Cuti</a>
									</li>
								<?php endif; ?>
								...
								<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 6 || $role_id == 13): ?>
									<li <?php if ($title == "Training") {
										echo 'class="active"';
											...
											href="<?= base_url('Training'); ?>">1. TNA</a></li>
								<?php endif; ?>
								...
								<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 6 || $role_id == 13): ?>
									<li <?php if ($title == "Training Program") {
										echo 'class="active"';
											...
											href="<?= base_url('Training/index_training_program'); ?>">2. Program
											Training</a></li>
								<?php endif; ?>
								...
								<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 13): ?>
									<li <?php if ($title == "Add Training Record") {
										echo 'class="active"';
											...
											href="<?= base_url('Training_report/addTraining'); ?>">3. Add Record
											Training</a></li>
								<?php endif; ?>
								...
								<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 13): ?>
									<li <?php if ($title == "Training Record") {
										echo 'class="active"';
											...
											href="<?= base_url('Training_report'); ?>">4. Record Training</a></li>
								<?php endif; ?>
								...
								<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 13): ?>
									<li <?php if ($title == "Evaluasi Training") {
										echo 'class="active"';
											...
											href="<?= base_url('Training_report'); ?>">5. Evaluasi Training</a>
									</li>
								<?php endif; ?>
								...
								<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 13): ?>
									<li <?php if ($title == "Upload Data Training") {
										echo 'class="active"';
											...
											href="<?= base_url('UploadDataTraining'); ?>">6. Upload Data
											Training</a></li>
								<?php endif; ?>
								...
								<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 6 || $role_id == 13): ?>
									<li <?php if ($title == "Kompetensi") {
										echo 'class="active"';
											...
											href="<?= base_url('Kompetensi'); ?>">Kompetensi</a></li>
								<?php endif; ?>
								...
								<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 6 || $role_id == 13): ?>
									<li <?php if ($title == "Job Description") {
										echo 'class="active"';
											...
											href="<?= base_url('job_description'); ?>">Job Description</a></li>
								<?php endif; ?>
								...
								<?php if ($role_id == 1 || $role_id == 2 || $role_id == 3 || $role_id == 4 || $role_id == 5 || $role_id == 13): ?>
									<li <?php if ($title == "HR Admin") {
										echo 'class="active"';
											...
											href="<?= base_url('hr_admin/karyawanbaru'); ?>">Memo karyawan baru</a>
									</li>
								<?php endif; ?>
							</ul>
						</li>
