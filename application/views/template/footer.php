...
<script type="text/javascript">
    $(document).ready(function() {
        var unique_id = $.gritter.add({
            ...
            title: 'Welcome to Personalia!',
            // (string | mandatory) the text inside the notification
            text: 'PT Indo Taichen Textile Industri',
            // (string | optional) the image to display on the left
            image: '<?= base_url(); ?>img/logoitti.png',
...
<script src="<?= base_url(); ?>chosen/docsupport/prism.js" type="text/javascript" charset="utf-8"></script>
<script src="<?= base_url(); ?>chosen/docsupport/init.js" type="text/javascript" charset="utf-8"></script>
