                    ...
                    <div class=" form">
                        <form class="cmxform form-horizontal style-form" action="<?= base_url('data_karyawan/edit/') . $user['name']; ?>" method="post">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control input-sm chosen-select" data-placeholder="Choose a Country..." tabindex="2" name="kabupaten_domisili" required>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control input-sm chosen-select" data-placeholder="Choose a Country..." tabindex="2" name="kecamatan_domisili" required>
