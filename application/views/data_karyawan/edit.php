...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row mt">
            ...
            <div class="col-lg-12">
                <h4><i class="fa fa-angle-right"></i><a href="<?= base_url('data_karyawan'); ?>"> Employee Information
                    </a><i class="fa fa-angle-right"></i> Edit Form Employee</h4>
                <form class="form-style-4"
                    action="<?= base_url('data_karyawan/addEmployed/') . $user['name'] . '/' . $makar->id; ?>"
                    method="post">
                        ...
                        <div class="form">
                                    ...
                                    <tr>
                                        <th>
                                            <label>
                                                ...
                                                <input type="text" value="<?= $makar->no_ktp; ?>" name="no_ktp"
                                                    placeholder="Nomor KTP" required autofocus>
                                                <span style="color: red;"><i><b>Jika ingin duplicate data, tambahkan
                                                            kutip (') hanya diawal karakter.</b></i></span>
                                            </label>
                                        </th>
                                        <th>
                                            <label>
                                                <span>Nomor SCAN <span style="color: red">(*)</span></span><br>
                                                <input type="number" value="<?= $makar->no_scan; ?>" name="no_scan"
                                                    placeholder="Nomor Absen/Scan" required>
                                            </label>
                                        </th>
                                        <th>
                                            <label>
                                                <span>Nama Lengkap <span style="color: red">(*)</span></span><br>
                                                <input type="text" value="<?= $makar->nama; ?>"
                                                    onkeyup="this.value = this.value.toUpperCase();" name="nama"
                                    ...
                                    <tr>
                                        <th>
                                            <label>
                                                ...
                                                <input type="text" value="<?= $makar->tempat_lahir; ?>"
                                        ...
                                        <th>
                                            <label>
                                                ...
                                                <input type="date" value="<?= $makar->tgl_lahir; ?>" name="tgl_lahir"
                                                    required>
                                            </label>
                                        </th>
                                        <th>
                                            <label>
                                                ...
                                                <input type="text" onkeyup="this.value = this.value.toUpperCase();"
                                                    value="<?= $makar->alamat_ktp; ?>" placeholder="Alamat Sesuai KTP"
                                                    name="alamat_ktp" required>
                                            </label>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th>
                                            <label>
                                                ...
                                                <input type="text" onkeyup="this.value = this.value.toUpperCase();"
                                                    value="<?= $makar->alamat_domisili; ?>" name="alamat_domisili"
                                                    placeholder="Alamat Domisi/Tinggal" required>
                                            </label>
                                        </th>
                                        <th>
                                            <label>
                                    ...
                                    <tr>
                                        <th>
                                            <label>
                                                ...
                                                <input type="text" name="kabupaten_domisili"
                                                    value="<?= $makar->kabupaten_domisili ?>" required>
                                            </label>
                                        </th>
                                        <th>
                                            <label>
                                                <span>Kecamatan Domisili <span style="color: red">(*)</span></span><br>
                                                <input type="text" name="kecamatan_domisili"
                                                    value="<?= $makar->kecamatan_domisili ?>" required>
                                            </label>
                                        </th>
                                        <th>
                                            <label>
                                                <span>Kode Pos <span style="color: red">(*)</span></span><br>
                                                <input type="number" value="<?= $makar->kode_pos; ?>" name="kode_pos"
                                    ...
                                    <tr>
                                        <th>
                                            <label>
                                                ...
                                                <select name="agama" class="select2" data-placeholder="Pilih Agama"
                                                    required>
                                        ...
                                        <th>
                                            <label>
                                                ...
                                                <select name="status_rumah" class="select2"
                                                    data-placeholder="Pilih Status Rumah" required>
                                                    <option value="" disabled selected>
                                                        ---------------------------------------------------</option>
                                                    <?php $queryReligion = $this->db->get('status_rumah')->result_array(); ?>
                                                    <?php foreach ($queryReligion as $dr): ?>
                                                    <option value="<?= $dr['code']; ?>" <?php if ($dr['code'] == $makar->status_rumah) {
															  echo "selected";
														  } ?>>
                                                        <?= $dr['code']; ?>
                                                    </option>
                                        ...
                                        <th>
                                            <label>
                                                ...
                                                <select class="select2" data-placeholder="Pilih Jenis Kelamin"
                                    ...
                                    <tr>
                                        <th>
                                            <label>
                                                ...
                                                <select class="select2" data-placeholder="Pilih Status Keluarga"
                                                    name="status_kel" required>
                                                    <option value="" disabled selected>
                                                        ---------------------------------------------------</option>
                                        ...
                                        <th>
                                            <label>
                                                ...
                                                <select class="select2" name="pendidikan"
                            ...
                            <th>
                                <label>
                                    ...
                                    <input value="<?= $makar->nama_sekolah ?>" name="nama_sekolah" type="text"
                            ...
                            <tr>
                                <th>
                                    <label>
                                        ...
                                        <input value="<?= $makar->jurusan; ?>" name="jurusan" type="text"
                                            placeholder="Jurusan">
                                    </label>
                                </th>
                                <th>
                                    <label>
                                        ...
                                        <input value="<?= $makar->ipk; ?>" name="ipk" type="number"
                                            placeholder="Nilai Terakhir">
                                    </label>
                                </th>
                                <th>
                                    <label>
                                        <span>Golongan Darah <span style="color: red">(*)</span></span><br>
                                        <select class="select2" name="gol_darah"
                            ...
                            <tr>
                                <th>
                                    <label>
                                        ...
                                        <input value="<?= $makar->email_pribadi; ?>" name="email_pribadi" type="text"
                                ...
                                <th>
                                    <label>
                                        ...
                                        <input value="<?= $makar->pengalaman_kerja; ?>" name="pengalaman_kerja"
                                            type="text" placeholder="Pengalaman Kerja">
                                    </label>
                                </th>
                                <th>
                                    <label>
                                        <span>Nomor Handphone </span><br>
                                        <input value="<?= $makar->no_hp; ?>" name="no_hp" type="text"
                            ...
                            <tr>
                                <th>
                                    <label>
                                        ...
                                        <input value="<?= $makar->kartu_keluarga; ?>" name="kartu_keluarga" type="text"
                                ...
                                <th>
                                    <label>
                                        ...
                                        <input value="<?= $makar->masa_berlaku_ktp; ?>" name="masa_berlaku_ktp"
                                            type="date">
                                        <span style="color: red;">*jika masa berlaku selamanya, <br>silahkan
                                            diabaikan.</span><br>
                                    </label>
                                </th>
                                <th>
                                    <label>
                                        ...
                                        <select name="status_seragam" class="select2"
                                            data-placeholder="Pilih status seragam dan ID Card" required>
                                            <option value="" disabled selected>
                                                ---------------------------------------------------</option>
                                            <?php $queryseragam = $this->db->get('status_idcseragam')->result_array(); ?>
                                            <?php foreach ($queryseragam as $dsg): ?>
                                            <option value="<?= $dsg['status_seragam'] ?>" <?php if ($dsg['status_seragam'] == $makar->status_seragam) {
													  echo "SELECTED";
												  } ?>>
                                                <?= $dsg['status_seragam'] ?>
                                            </option>
                                    ...
                                    <label>
                                        <span>Suku <span style="color: red">(*)</span></span><br>
                                        <select name="suku" class="select2" data-placeholder="Pilih Suku" required>
                                            <option value="" disabled selected>
                                                ---------------------------------------------------</option>
                                            <?php $querysuku = $this->db->get('suku')->result_array(); ?>
                                            <?php foreach ($querysuku as $dsk): ?>
                                            <option value="<?= $dsk['id']; ?>" <?php if ($dsk['id'] == $makar->id_suku) {
													  echo "selected";
												  } ?>>
                                                <?= $dsk['nama_suku']; ?>
                                            </option>
            ...
            <div class="form-panel">
                ...
                <table width="100%">
                    <thead>
                        <tr>
                            <th colspan="6" style="text-align:left"><label>
                                    <h4>DATA KELUARGA</h4>
                                </label> <i>*Jika ingin merubah <b>data keluarga</b>, silahkan hapus dan klik tanda +
                                    (tambah)</i></th>
                        </tr>
                        <tr>
                            <th></th>
                    ...
                    <tbody id="divSite">
                        ...
                        <tr>
                            <td>
                                <?php if ($result['nama']): ?>
                                <label>
                                    <input type='text' name='nama_keluarga_edit[]' class='form-control input-sm'
                                        placeholder='Nama Keluarga' value="<?= $result['nama'] ?>" readonly>
                                </label>
                                <?php else: ?>
                                <label>
                                    <input type='text' name='nama_keluarga[]' class='form-control input-sm'
                            ...
                            <td>
                                <label>
                                    <input type='text' name='hubungan_keluarga_edit[]' class='form-control input-sm'
                                        placeholder='Hubungan Keluarga' value="<?= $result['hubungan'] ?>" readonly>
                                </label>
                            </td>
                            <td>
                                <label>
                                    <input type='text' name='tempat_edit[]' class='form-control input-sm'
                                        placeholder='Tempat Lahir' value="<?= $result['tempat'] ?>" readonly>
                                </label>
                            </td>
                            <td>
                                <label>
                                    <input type='date' name='tgl_lahir_keluarga_edit[]' class='form-control input-sm'
                                        value="<?= $result['tgl_lahir'] ?>" readonly>
                                </label>
                            </td>
                            <td>
                                <label>
                                    <input type='text' name='pekerjaan_edit[]' class='form-control input-sm'
                                        placeholder="Pekerjaan" value="<?= $result['pekerjaan'] ?>" readonly>
                                </label>
                            </td>
                            <td>
                                <label>
                                    <span><a
                                            href="<?= base_url('data_karyawan/delete_data_keluarga/') . $result['id']; ?>">Hapus</a></span>
                                </label>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <label>
                                    <input type='text' name='hubungan_keluarga[]' class='form-control input-sm'
                                        placeholder='Hubungan Keluarga' required>
                                </label>
                            </td>
                            <td>
                                <label>
                                    <input type='text' name='tempat[]' class='form-control input-sm'
                ...
                <center>
                    <button type="button" class="btn btn-default btn-xs"
                        onclick="tambahDataKeluarga(); return false;"><i class="fa fa-plus"></i></button>
                </center>
            </div>
            <div class="form-panel">
                ...
                <table width="100%">
                    <thead>
                        <tr>
                            <th colspan="6" style="text-align:left"><label>
                                    <h4>PENGALAMAN KERJA</h4> <i>*Jika ingin merubah <b>pengalaman kerja</b>, silahkan
                                        hapus dan klik tanda + (tambah)</i>
                                </label></th>
                        </tr>
                        <tr>
                            <th></th>
                    ...
                    <tbody id="divSite_pk">
                        ...
                        <tr>
                            <td>
                                <label>
                                    <input type='text' name='nama_perusahaan_edit[]' class='form-control input-sm'
                                        placeholder="Nama Perusahaan" value="<?= $key['nama_perusahaan']; ?>" readonly>
                                </label>
                            </td>
                            <td>
                                <label>
                                    <input type='text' name='dept_perusahaan_edit[]' class='form-control input-sm'
                                        placeholder="Departemen" value="<?= $key['bagian']; ?>" readonly>
                                </label>
                            </td>
                            <td>
                                <label>
                                    <input type='text' name='jabatan_perusahaan_edit[]' class='form-control input-sm'
                                        placeholder="Jabatan" value="<?= $key['jabatan']; ?>" readonly>
                                </label>
                            </td>
                            <td>
                                <label>
                                    <input type='text' name='masa_kerja_perusahaan_edit[]' class='form-control input-sm'
                                        placeholder="Masa Kerja" value="<?= $key['masa_kerja']; ?>" readonly>
                                </label>
                            </td>
                            <td>
                                <label>
                                    <span><a
                                            href="<?= base_url('data_karyawan/delete_data_pengalaman_kerja/') . $key['id']; ?>">Hapus</a></span>
                                </label>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type='text' name='masa_kerja_perusahaan[]' class='form-control input-sm'
                                    required>
                            </td>
                            <td></td>
                        </tr>
                ...
                <center>
                    <button type="button" class="btn btn-default btn-xs"
                        onclick="tambahPengalamanKerja(); return false;"><i class="fa fa-plus"></i></button>
                </center>
            </div>
            <div class="form-panel">
                <table width="100%" border="0">
                    <tr>
                        <th>
                            <label>
                                ...
                                <select class="select2" data-placeholder="Pilih Status Karyawan" name="status_karyawan"
                                    id="sk" onChange="_sk();" required>
                                    <?php
                        ...
                        <th>
                            <label>
                                ...
                                <select class="select2" data-placeholder="Pilih Satu Jabatan" name="jabatan" required>
                                    ...
                                    <option value="<?= $dj['jabatan']; ?>" <?php if ($dj['jabatan'] == $makar->jabatan) {
											  echo "SELECTED";
										  } ?>>
                                        <?= $dj['jabatan']; ?>
                                    </option>
                    ...
                    <tr>
                        ...
                        <th>
                            <label>
                                ...
                                <input type="date" value="<?= $makar->tgl_masuk; ?>" name="tgl_masuk"
                                    placeholder="Tanggal Masuk Karyawan" required>
                            </label>
                        </th>
                    </tr>
                    <tr>
                        <th>
                            <label>
								...
								?>
                                <input class="form-control input-sm input-sm" value="<?= $kontrak1; ?>"
                                    name="kontrak_awal" id="kontrak_awal" type="date" <?php if ($makar->status_karyawan == "Kontrak1" || $makar->status_karyawan == "Kontrak2" || $makar->status_karyawan == "Resigned") {
										echo "";
									} else {
										echo "readonly";
									} ?>>
                        ...
                        <th>
                            <label>
                                ...
                                <input class="form-control input-sm input-sm" value="<?= $kontrak2; ?>"
                                    name="kontrak_akhir" id="kontrak_akhir" type="date" <?php if ($makar->status_karyawan == "Kontrak1" || $makar->status_karyawan == "Kontrak2" || $makar->status_karyawan == "Resigned") {
										echo "";
									} else {
										echo "readonly";
									} ?>>
                        ...
                        <th>
                            <label>
                                ...
                                <input class="form-control input-sm input-sm" value="<?= $makar->tgl_tetap; ?>"
                                    id="tgltetap" name="tgl_tetap" type="date" <?php if ($makar->status_karyawan == "Kontrak1" || $makar->status_karyawan == "Kontrak2" || $makar->status_karyawan == "Resigned") {
										echo "readonly";
									} ?>>
                            </label>
                        </th>
                        ...
                        <th>
                            <label>
                                ...
                                <select class="select2" data-placeholder="Atasan 1" name="atasan1" id="atasan1"
                                    ...
                                    <option value="<?= $dk['nama'] ?>" <?php if ($dk['nama'] == $makar->atasan1) {
											  echo "SELECTED";
										  } ?>>
                        ...
                        <th>
                            <label>
                                ...
                                <select class="select2" data-placeholder="Atasan 2" name="atasan2" id="atasan2"
									...
									?>
                                    <?php foreach ($queryShift as $dk): ?>
                                    <option value="<?= $dk['nama'] ?>" <?php if ($dk['nama'] == $makar->atasan2) {
											  echo "SELECTED";
										  } ?>>
                                        <?= $dk['nama'] . ' - ' . $dk['dept'] . ' ' . $dk['jabatan']; ?>
                                    </option>
                        ...
                        <th>
                            <label>
                                ...
                                <select name="status_aktif" required>
                                    ...
                                    <option value="1" <?php if (1 == $makar->status_aktif) {
										echo "SELECTED";
									} ?>>Aktif
                                    </option>
                                    <option value="0" <?php if (0 == $makar->status_aktif) {
										echo "SELECTED";
									} ?>>Tidak
                                        Aktif</option>
                                </select>
                    ...
                    <tr>
                        <th>
                            <label>
                                ...
                                <input name="no_bpjs_tk" type="text" value="<?= $makar->no_bpjs_tk; ?>"
                        ...
                        <th>
                            <label>
                                ...
                                <input name="no_bpjs_kes" type="text" value="<?= $makar->no_bpjs_kes; ?>"
                        ...
                        <th>
                            <label>
                                ...
                                <input name="ukuran_baju_shirt" type="text" value="<?= $makar->ukuran_baju_shirt; ?>"
                                    placeholder="No. BPJS Kesehatan">
                            </label>
                        </th>
                    </tr>
                    <tr>
                        <th>
                            <label>
                                ...
                                <input name="alamat_npwp" type="text" value="<?= $makar->alamat_npwp; ?>"
                        ...
                        <th>
                            <label>
                                ...
                                <input name="ukuran_baju_polo" type="text" value="<?= $makar->ukuran_baju_polo; ?>"
                                    placeholder="No. NPWP">
                            </label>
                        </th>
                    </tr>
                    <tr>
                        ...
                        <th>
                            ...
                            <label>
                                ...
                                <input class="form-control input-sm" value="<?= $makar->tgl_resign; ?>" id="tglresign"
                                    name="tgl_resign" type="date">
                            </label>
                            <?php else: ?>
                            <label>
                                <span>Tgl Evaluasi Karyawan Baru </span><br>
                                <input type="date" id="tgl_evaluasi" name="tgl_evaluasi"
                                    placeholder="Tanggal Evaluasi Karyawan" value="<?= $makar->tgl_evaluasi; ?>"
                                    readonly>
                            </label>
                    ...
                    <tr>
                        <th><br><br>
                            <label>
                                ...
                                <button class="btn btn-default btn-sm" type="submit" name="duplicate"
                                    value="1">Duplicate</button>
