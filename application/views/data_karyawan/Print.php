        ...
        <tbody>
          ...
          <tr class="row24">
            ...
            <td class="column7 style86 s style87" colspan="5"><?php if($makar->status_karyawan == "Tetap"){ echo "R"; } else { echo "*"; } ?><span style="color:#000000; font-family:'Arial'; font-size:9pt"> Karyawan Tetap</span></td> -->
						<td class="column4 style86 s style86" colspan="3"><?php  { echo "*"; } ?><span style="color:#000000; font-family:'Arial'; font-size:9pt"> Kontrak</span></td>
            <td class="column7 style86 s style87" colspan="5"><?php  { echo "*"; } ?><span style="color:#000000; font-family:'Arial'; font-size:9pt"> Karyawan Tetap</span></td>
          </tr>
          <tr class="row25">
            <td class="column0 style76 null style76" colspan="12"></td>
          </tr>
