                                    ...
                                    <tr>
                                       ...
                                       <th>
                                        ...
                                        <!-- <form method='POST' action='Simpan'>  
                                            <div class='status_seragam'>
                                                <label><span>Seragam</span> <input type="checkbox" name="seragam" alt="Checkbox" value="Belum"> Belum&nbsp;&nbsp;<input type="checkbox" name="Seragam" alt="Checkbox" value="Sudah"> Sudah
                                                </label>
                                            </div>
                                                                                                                             
                                            <div class='status_idcard'>
                                                <label><span>ID card</span><br>
                                                <input type="checkbox" name="seragam" alt="Checkbox" value="Belum"> Belum &nbsp;&nbsp;<input type="checkbox" name="idcard" alt="Checkbox" value="Sudah"> Sudah                                      
                                                </label>
                                            </div>
                                            </form> -->
                                            ...
                                            <!-- <label>
                                                <span>ID Card <span style="color: red">(*)</span></span>
                                                <select name="status_idcard" class="select2" data-placeholder="Pilih Status Idcard" required>
                                                    <option value="" disabled selected>---------------------------------------------------</option>
                                                    < <option value="Sudah">Sudah</option>
...
<!-- 
                                        <label>
                                        <span>Seragam<span style="color: red">(*)</span></span>
                                        <select class='select2' name="status_seragam" required><br><br>
                                            <option value="" disabled selected>Pilih Status Seragam</option>
                                            <option value="Sudah">Sudah</option>
                                            <option value="Belum">Belum</option>
                                        </select><br>
                                          <span>Id Card<span style="color: red">(*)</span></span>
                                        <select class='select2'  name="status_idcard" required>
                                            <option value="" disabled selected>Pilih Status Id Card</option>
                                            <option value="Sudah">Sudah</option>
                                            <option value="Sudah">Belum</option>
                                        </select> </label>
                                    </th> -->
                    ...
                    <div class="form-panel">
                        <table width="100%" border="0">
                            ...
                            <tr>
                                ...
                                <th>
                                    <label>
                                        <span>Bagian <span style="color: red">(*)</span></span>
                                        <input type="text" value="<?= set_value('bagian'); ?>" name="bagian" required>
                                    </label>
                                </th>
                                <th>
                                    <label>
