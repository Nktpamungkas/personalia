<section id="main-content">
    <section class="wrapper">
        ...
        <div class="col-md-6">
            ...
            <p class="inline">
                <a href="<?= base_url('data_karyawan/addNewEmployee'); ?>" class="btn btn-info btn-sm"><i
                        class=" fa fa-plus"></i>&nbsp;&nbsp;Add New Employee</a></<a>
                <!-- <a href="<?= base_url('users/index'); ?>" class="btn btn-info btn-sm"><i class=" fa fa-plus"></i>&nbsp;&nbsp;Upload Data New Employee</a></<a> -->
                <a href="<?= base_url('data_karyawan/ExportToExcell'); ?>" class="btn btn-default btn-sm">Export to
                    Excel</a>
                <?php endif; ?>
            </p>
        </div>
                                ...
                                success: function(data) {
                                    ...
                                    for (i = 0; i < data.length; i++) {
                                        html += '<tr class="gradeX">' +
                                            <?php if ($user['dept'] == "HRD" || $user['dept'] == "DIT" ): ?> `<td>
															<?php if ($user['special_user'] ==1 ): ?>
																	<li class="dropdown" style="list-style-type:none;">
																		<a href="#" class="fa fa-align-justify" data-toggle="dropdown"></a>
																		<ul class="dropdown-menu">
																			<li><a href="<?= base_url(); ?>data_karyawan/edit_employee/` +
                                            data[i].no_scan +
                                            `"><i class="fa fa-edit"></i> Edit</a></li>
																										<li><a href="#" data-toggle="modal" data-target="#modalResign` +
                                            data[i].no_scan +
                                            `"><i class="fa fa-sign-out"></i>Pengajuan Resign</a></li>
																										<li><a href="<?= base_url(); ?>data_karyawan/print_datakaryawan/` +
                                            data[i].no_scan +
                                            `"><i class="fa fa-print"></i> Print</a></li>
																										<li><a href="<?= base_url(); ?>data_karyawan/tanda_tangan/` +
                                            data[i]
                                            .no_scan +
                                            `"><i class="fa fa-gears"></i> Buat Tanda Tangan</a></li>
																										<li><a href="<?= base_url(); ?>Career_adm/AddCareerTransition/` +
                                            data[i].no_scan +
                                            `"><i class="fa fa-gears"></i> Career Transition</a></li>
																										<li class="divider"></li>
																										<li><a href="#" data-toggle="modal" data-target="#modalDelete` +
                                            data[i].no_scan + `"><i class="fa fa-trash"></i> Delete</a></li>
																									</ul>
																	</li>
															<?php endif; ?>
                                            ...
                                            data[i].no_scan + `" name="no_scan" type="hidden">
															...
															<!-- Modal Resign-->
															<div class="modal fade" id="modalResign` + data[i].no_scan +
                                            ...
                                            `" name="dept" readonly>
																					...
																					<div class="col-lg-7">
																					   <input class="form-control input-sm" value="` +
                                            data[i].jabatan + `" name="jabatan" readonly>
																					 </div>
																					<div class="col-lg-5">
																						<label class="control-label col-lg-12">Masukan Tanggal  Resign</label>
																					</div>
																					<div class="col-lg-7">
																						<input value="` + data[i].no_scan +
                                            `" id="no_scan" name="no_scan" type="hidden" >
																						<input class="form-control input-sm" value="` +
                                            data[i].tgl_resign + `" name="tgl_resign" type="date" required>
																					</div>
																					<div class="col-lg-5">
																					...
																					<div class="col-lg-7">
																						...
																						<?php foreach ($queryketresign as $dp): ?>
																							<option value="<?= $dp['desc_resign'] ?>" <?php if ($dp['desc_resign'] == set_value('desc_resign')) {
																								  echo "SELECTED";
																							  } ?>><?= $dp['desc_resign'] ?></option>
																						<?php endforeach; ?>
																					</select>
																					</div>
																				 </div>
                                            ...
                                            <?php if ($user['dept'] == "HRD" || $user['dept'] == "DIT"): ?> '<td>' +
                                            data[i].bagian + '</td>' +
                                            <?php endif; ?> '<td>' + data[i].jabatan + '</td>' +
                                            <?php if ($user['dept'] == "HRD" || $user['dept'] == "DIT"): ?> '<td><center>' +
                                            data[i].tgl_masuk + '</center></td>' +
