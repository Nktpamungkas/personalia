                    ...
                    <div class=" form">
                        <form class="cmxform form-horizontal style-form" action="<?= base_url('training_report/add/') . $user['name']; ?>" method="post">
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control chosen-select" data-placeholder="Choose a Country..." tabindex="2" name="no_scan" required>
                                        ...
                                        <?php 
                                            $queryNoScan = $this->db->query('SELECT * FROM tbl_makar ORDER BY nama ASC')->result_array(); 
                                        ?>
                                        <?php foreach ($queryNoScan as $dnc) : ?>
                                            <option value="<?= $dnc['no_scan'] ?>"><?= $dnc['nama'] . ' - ' . $dnc['no_scan'] ?></option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control chosen-select" data-placeholder="Choose a Country..." tabindex="2" name="kode_training" required>
                                        ...
                                        ?>
                                        <?php foreach ($queryNoScan as $dnc) : ?>
                                            <option value="<?= $dnc['kode'] ?>"><?= $dnc['materi_training'] . ' - (Jenis Training) ' . $dnc['jenis_training'] . ', (Penyelenggara) ' . $dnc['penyelenggara'] . ', (Tempat) ' . $dnc['tempat'] . ', (Sertifikat)' . $dnc['sertifikat']   ?></option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <!-- <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    <input class="form-control input-sm" value="<?= set_value('tempat'); ?>" name="tempat" type="text">
                                </div>
                            </div>
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control chosen-select" data-placeholder="Choose a Country..." tabindex="2" name="sertifikat" required>
                                        ...
                                        <?php foreach ($querySertifikat as $ds) : ?>
                                            <option value="<?= $ds['sertifikat'] ?>"><?= $ds['sertifikat'] ?></option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                            </div> -->
